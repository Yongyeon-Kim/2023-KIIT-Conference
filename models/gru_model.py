...
checkpoint = ModelCheckpoint('../models/log/GRU_best_model.h5', save_best_only=True, monitor='val_accuracy', mode='max')
...
best_model = load_model('../models/log/GRU_best_model.h5')
...
print("GRU 정확도:", accuracy)

with open("../models/log/GRU.txt", "w") as file:
